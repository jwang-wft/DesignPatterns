...
/**
 * 61 * Represents a date using an integer, in a similar fashion to the 62 *
 * implementation in Microsoft Excel. The range of dates supported is 1-Jan-1900
 * to 31-Dec-9999. 64 *
 * <P>
 * 65 * Be aware that there is a deliberate bug in Excel that recognises the
 * year 66 * 1900 as a leap year when in fact it is not a leap year. You can
 * find more 67 * information on the Microsoft website in article Q181370: 68 *
 * <P>
 * 69 * http://support.microsoft.com/support/kb/articles/Q181/3/70.asp 70 *
 * <P>
 * 71 * Excel uses the convention that 1-Jan-1900 = 1. This class uses the 72 *
 * convention 1-Jan-1900 = 2. 73 * The result is that the day number in this
 * class will be different to the 74 * Excel figure for January and February
 * 1900...but then Excel adds in an extra 75 * day (29-Feb-1900 which does not
 * actually exist!) and from that point forward 76 * the day numbers will match.
 * 77 * 78 * @author David Gilbert 79
 */
public class SpreadsheetDate extends SerialDate {
	...
	/**
	 * 104 * Creates a new date instance. 105 * 106 * @param day the day (in the
	 * range 1 to 28/29/30/31). 107 * @param month the month (in the range 1 to
	 * 12). 108 * @param year the year (in the range 1900 to 9999). 109
	 */
