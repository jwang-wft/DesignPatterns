package com.wang.cleancode.serialdate;

import java.util.GregorianCalendar;

import junit.framework.TestCase;

import static com.wang.cleancode.serialdate.SerialDate.*;
...
public class BobsSerialDateTest extends TestCase {
	...
	public void testGetNearestDayOfWeek() throws Exception {
		...
		// assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(16,
		// APRIL, 2006)));
		// assertEquals(d(18, APRIL, 2006), getNearestDayOfWeek(TUESDAY, d(17,
		// APRIL, 2006)));
		...
		// assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(16,
		// APRIL, 2006)));
		// assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(17,
		// APRIL, 2006)));
		// assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(18,
		// APRIL, 2006)));
		...
		// assertEquals(d(13, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(16,
		// APRIL, 2006)));
		// assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(17,
		// APRIL, 2006)));
		// assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(18,
		// APRIL, 2006)));
		// assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(THURSDAY, d(19,
		// APRIL, 2006)));
		...
		// assertEquals(d(14, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(16,
		// APRIL, 2006)));
		// assertEquals(d(14, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(17,
		// APRIL, 2006)));
		// assertEquals(d(21, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(18,
		// APRIL, 2006)));
		// assertEquals(d(21, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(19,
		// APRIL, 2006)));
		// assertEquals(d(21, APRIL, 2006), getNearestDayOfWeek(FRIDAY, d(20,
		// APRIL, 2006)));
		...
		// assertEquals(d(15, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(16,
		// APRIL, 2006)));
		// assertEquals(d(15, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(17,
		// APRIL, 2006)));
		// assertEquals(d(15, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(18,
		// APRIL, 2006)));
		// assertEquals(d(22, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(19,
		// APRIL, 2006)));
		// assertEquals(d(22, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(20,
		// APRIL, 2006)));
		// assertEquals(d(22, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(21,
		// APRIL, 2006)));
