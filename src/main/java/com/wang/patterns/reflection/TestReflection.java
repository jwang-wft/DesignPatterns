...
public class TestReflection {
	...
	public static void main(String[] args) {
		...
		Constructor<UFOEnemyShip> constructor = null;
		...
		try {
			...
			try {
				...
				newEnemyShip = constructor.newInstance(shipFactory);
			} catch (Exception e1) {
				e1.printStackTrace();
			}
			...
			try {
				...
				Method privateMethod = UFOEnemyShip.class.getDeclaredMethod(methodName, (Class<?>)null);
				...
				String privateReturnVal = (String) privateMethod.invoke(enemyshipPrivate, (Class<?>)null);
